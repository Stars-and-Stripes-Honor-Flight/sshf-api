import { MangoFindRequest } from '../models/mango_find_request.js';
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/MangoFindRequest'
 *           examples:
 *             basicQuery:
 ...
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/MangoFindResponse'
 *             examples:
 *               success:
...
export async function postFind(req, res, next) {
    try {
        ...
        const findRequest = new MangoFindRequest(req.body);
        
        // Build CouchDB _find request body
        const requestBody = findRequest.toRequestBody();
